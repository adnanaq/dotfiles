...
# echo "dbus launched to keep WSL alive"
# fi

# Neovim path for global access
export PATH="$PATH:/opt/nvim/"

# Go path for global access
export PATH="$PATH:/usr/local/go/bin"
# Go package documentation
export PATH="$PATH:$HOME/go/bin"
# Enable cgo to allow Go's race detector to function properly
export CGO_ENABLED=1
# Protocol Buffer Compiler
export PATH="$PATH:$HOME/.local/bin"

# Conda path
# export PATH="/home/dani/anaconda3/bin:$PATH"  # commented out by conda initialize
